    ...
    <body class="login">
      ...
      <div class="w-full max-w-sm mx-auto p-3 bg-[#D9AE84] border border-[#D9AE84] rounded-lg shadow sm:p-2 md:p-4 transform translate-y-20">
          <form class="space-y-6" action="#">
              ...
              <button type="submit" class="w-full text-white hover:text-black focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-opacity-90 focus:ring-[#736356] bg-[#736356]">Login to your account</button>
